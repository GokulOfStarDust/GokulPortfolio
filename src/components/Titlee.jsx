...
const Titlee = () => {
  ...
  return (
    <>
      <div>
        <h1  className="pb-2  md:p-10 text-[#FF535B]   mt-[64vh] md:mt-0  font-coolvetica">
      ...
      <div  className="sidec  flex flex-col justify-center ml-0 items-center   min-[414px]:mt-9 md:items-end md:mr-20 md:mt-0 xl:mt-0  lg:mr-24 lg:justify-center lg:mt-16 lg:items-end xl:items-end xl:mr-36 xl:justify-center xxl:mt-[200px]">
